<template>
                    ...
                    <dt class="text-sm font-medium text-gray-500">
                        <div class='flex'>
                            ...
                            <div>
                                 <span>{{pilote.civility}} {{pilote.firstname}} {{pilote.lastname}}  </span>
                                <div class='flex'>
                                    <span>{{pilote.birthdate}}</span>

                                    <div class="text-sm   flex justify-between  text-gray-900" v-if="pilote.licence_status === 'valide'" >
                                     ...
                                     <div class="text-sm  flex justify-between text-gray-900" v-if="pilote.licence_status === 'invalide'" >
                                     ...
                                     <div class="text-sm text-gray-900" v-else-if="pilote.licence_status === 'send'" >
                    ...
                    <dd class="mt-1 text-sm flex justify-between text-gray-900 sm:mt-0 sm:col-span-2">
                        ...
                        <div  class='text-center '>
                            <p class='mx-3'>{{pilote.email}}</p>
                            <p class='mx-3'>{{pilote.mobile}}</p>


                        </div>

                        <div  class='text-center ml-2'>
                            <p class='mx-3'>Permis </p>
                             <button  @click="startConfirmingDrivingLicence">
                        ...
                        <form @submit.prevent="submit(pilote.id)" class='flex'>

                        <div>
                            <select class="  text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mx-3" id="status" v-model='form.licence_status' >
                    ...
                    <span>
                        <jet-dialog-modal :show="confirmingDrivingLicence" @close="closeModal">
                            <template #title>
                                <p>Permis de conduire</p>
                            </template>

                            <template #content>
                            <iframe :src="'/storage/'+pilote.driving_licence" class='h-screen items-center w-11/12'></iframe>
                            </template>
                 ...
                 <jet-dialog-modal :show="confirmingDeletePilote" @close="closeModal">
                     ...
                     <template #content>
                         <div>
                            Vueillez confirmer la suppression du pilote {{pilote.firstname}} {{pilote.lastname}}.
...
<script>
    ...
    export default defineComponent({
        ...
        components: {
         ...
         data() {
             return {
                ...
                confirmingDrivingLicence: false,
        ...
        methods: {
            ...
            submit($id) {
                this.form.put(route("admin.pilote.update", { id: $id}),{
                preserveScroll: true,
                onSuccess: () => (this.form.reset)

                });
            },
           startConfirmingDrivingLicence() {

                    this.confirmingDrivingLicence = true;
                },
            ...
            closeModal() {
                this.confirmingDrivingLicence = false,
