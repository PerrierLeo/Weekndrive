<template>
                    ...
                    <div class="relative w-full h-80 md:h-64 lg:h-44">
                        ...
                        <img :src="'/storage/'+car.car_photo"
                            alt=""
                            class="w-full h-full object-center object-cover">
                    </div>
                    <div class="px-3 py-4">
                        <h3 class="text-sm text-gray-500 pb-2">
                            <div class="bg-indigo-600 py-1 px-2 text-white rounded-lg" href="#">
                        ...
                        <div class="col-span-6 sm:col-span-4 mt-2" v-if="car.status == 'send'">
                            <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg">
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-200">Votre véhicule est en cours de validation par nos équipes !</p>

                                </div>
                            </div>
                        </div>

                        <div class="col-span-6 sm:col-span-4 mt-2" v-if="car.status == 'valide'">
                            <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg">
                                <div>
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-200">Vous pouvez désormais vous inscrire aux évènements avec votre {{car.brand}} {{car.model}} !</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-span-6 sm:col-span-4 mt-2" v-if="car.status == 'invalide'">
                            <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg">
                                <div>
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-200">Vos documents ne correspondent pas au véhicule.</p>
                                </div>
                            </div>
                        </div>
